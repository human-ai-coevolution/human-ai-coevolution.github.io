...
## Top Keywords
`automation bias` (12) · `ChatGPT` (11) · `RCT` (9) · `trust` (9) · `governance` (9)<br>`productivity` (8) · `RLHF` (8) · `Copilot` (8) · `trust calibration` (7) · `longitudinal` (7)<br>`agentic AI` (6) · `alignment` (6) · `sycophancy` (6) · `reliance` (6) · `over-reliance` (6)<br>`benchmark` (3) · `dataset` (3) · `survey` (3)

## Top Contributing Authors
Mor Naaman (6) · Zahra Zahedi (5) · Subbarao Kambhampati (5) · Diyi Yang (4) · Daniel Buschek (4)<br>Sarath Sreedharan (4) · Dario Amodei (4) · Mina Lee (3) · Kevin Wei (3) · Noam Kolt (3)<br>Lev Tankelevitch (3) · Advait Sarkar (3) · Sandhini Agarwal (3) · Eric Horvitz (3) · Ethan Perez (3)<br>Samuel R. Bowman (3) · Amanda Askell (3) · Jeffrey T. Hancock (3) · Jan Leike (3) · Raja Parasuraman (3)
...
> Full searchable index: **<https://xli04.github.io/Awesome-Human-AI-Coevolution-Paper-List/>**. Structured source of truth: [`papers.yaml`](papers.yaml) (218 entries). Framework definitions: [`deep_research/phased_framework.md`](deep_research/phased_framework.md). Each paper is assigned a single phase, with `emerging-phase-X` for clear bridge cases; the secondary 5-category axis (CC/MA/HF/LH/PS) is also stored per entry.

### Phase 1 — Humans Use AI as Tool  <sub>(61 papers)</sub>
...
### Emerging Phase 2 — Tool → Assistant  <sub>(15 papers)</sub>
...
### Phase 2 — Humans Use AI as Assistant  <sub>(52 papers)</sub>
...
### Emerging Phase 3 — Assistant → Executor  <sub>(8 papers)</sub>
...
### Phase 3 — Humans Use AI as Executor  <sub>(25 papers)</sub>
...
### Emerging Phase 4 — Executor → Organization  <sub>(30 papers)</sub>
...
### Surveys & Position Papers  <sub>(27 papers)</sub>
